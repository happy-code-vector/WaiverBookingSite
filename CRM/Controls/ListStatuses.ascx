<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListStatuses.ascx.cs" Inherits="WaiverFile.CRM.Controls.ListStatuses" %>
            <%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>


<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Statuss
<span class="addbuttons"><a href="?sc=WFCRM_EDIT_STATUS&c=1" class="ico_add">Add</a></span>
</h3>
    </div><!-- /.box-header -->
    ...
    <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="ID">
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn DataField="description" FilterControlAltText="Filter description column" HeaderText="Description" SortExpression="description" UniqueName="description"></telerik:GridBoundColumn>
                        ...
                        <telerik:GridHyperLinkColumn AllowSorting="False" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="/wp-admin/default.aspx?id={0}&amp;sc=WFCRM_EDIT_STATUS&amp;c=1" FilterControlAltText="Filter column1 column" HeaderText="Edit" Text="Edit" UniqueName="column1" AllowFiltering="False">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WaiverFileDB %>"  ProviderName="System.Data.SqlClient" SelectCommand="select * from tblCRMStatus where isdeleted=0">
                  </asp:SqlDataSource>
