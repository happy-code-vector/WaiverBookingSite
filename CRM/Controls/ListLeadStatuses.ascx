<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListLeadStatuses.ascx.cs" Inherits="WaiverFile.CRM.Controls.ListLeadStatuses" %>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Lead Status
<span class="addbuttons"><a href="?sc=WFCRM_EDIT_LEAD_STATUS&c=1" class="ico_add">Add</a></span>
</h3>
    </div><!-- /.box-header -->
    ...
    <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="ID">
        ...
        <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="description" FilterControlAltText="Filter description column" HeaderText="Description" SortExpression="description" UniqueName="description"></telerik:GridBoundColumn>
                         ...
                         <telerik:GridBoundColumn DataField="orderNumber" FilterControlAltText="Filter OrderNumber column" HeaderText="OrderNumber" SortExpression="orderNumber" UniqueName="orderNumber"></telerik:GridBoundColumn>
                        ...
                        <telerik:GridHyperLinkColumn AllowSorting="False" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="/wp-admin/default.aspx?id={0}&amp;sc=WFCRM_EDIT_LEAD_STATUS&amp;c=1" FilterControlAltText="Filter column1 column" HeaderText="Edit" Text="Edit" UniqueName="column1" AllowFiltering="False">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WaiverFileDB %>"  ProviderName="System.Data.SqlClient" SelectCommand="select * from tblCRMLeadStatus order by ordernumber, name">
                  </asp:SqlDataSource>
