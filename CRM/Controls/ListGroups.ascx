<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListGroups.ascx.cs" Inherits="WaiverFile.CRM.Controls.ListGroups" %>
...
<span class="addbuttons"><a href="?sc=WFCRM_EDIT_GROUPS&c=1" class="ico_add">Add</a></span>
</h3>
    </div><!-- /.box-header -->
...
<telerik:RadGrid ID="RadGrid1" runat="server" Skin="Waypoint" EnableEmbeddedSkins="false" AutoGenerateColumns="False" OnItemDataBound="RadGrid1_ItemDataBound" OnDeleteCommand="RadGrid1_DeleteCommand" DataSourceID="SqlDataSource1" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True">
    ...
    <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="ID">
        ...
        <Columns>
                        ...
                        <telerik:GridHyperLinkColumn AllowSorting="False" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="/wp-admin/default.aspx?id={0}&amp;sc=WFCRM_EDIT_GROUPS&amp;c=1" FilterControlAltText="Filter column1 column" HeaderText="Edit" Text="Edit" UniqueName="column1" AllowFiltering="False">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WaiverFileDB %>"  ProviderName="System.Data.SqlClient" SelectCommand="select * from tblCRMGroup">
                  </asp:SqlDataSource>
