...
<%@ Page Title="Login" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WaiverFile.site.Login" %> 
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"> 
</asp:Content> 
<%@ register src="~/Controls/IPALogin.ascx" tagprefix="uc1" tagname="IPALogin" %> 
...
<uc1:IPALogin runat ="server" id="IPALogin1" /> 
