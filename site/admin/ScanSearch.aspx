<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ScanSearch.aspx.cs" Inherits="WaiverFile.site.admin.ScanSearch" %>
...
<h3>QR-Code Check-In Search </h3>
<p>Search for waivers with Check-in Status.</p>
...
<div class="row">
    ...
    <div class="col-md-4 col-sm-6">
        <div class="form-group">
            <label><asp:Label ID="lblQRCode" runat="server">QR Code</asp:Label></label>
            <asp:TextBox CssClass="form-control" runat="server" ID="txtQRCode"></asp:TextBox>
        </div>
    </div>
    <div class="col-md-4 col-sm-6">
        <div class="form-group">
