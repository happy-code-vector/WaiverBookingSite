<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditAdminSMSMessage.aspx.cs" Inherits="WaiverFile.site.admin.SMS.EditAdminSMSMessage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ph0" runat="server">
       ...
       <div class="row">
           <div class="col-xs-6">
                <h3>Administrative SMS Message</h3>
                <asp:PlaceHolder ID="phErr" runat="server"></asp:PlaceHolder>
               

                 <div class="form-group">
                     <label for="<%=cboMessageType.ClientID %>">Message Type</label><asp:DropDownList ID="cboMessageType" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbo_SelectedIndexChanged"></asp:DropDownList>
                </div>

               
                 <div class="form-group">
                     <label for="<%=cboStatus.ClientID %>">Status</label><asp:DropDownList ID="cboStatus" CssClass="form-control" runat="server" OnSelectedIndexChanged="cbo_SelectedIndexChanged"></asp:DropDownList>
                </div>
                    ...
                    <div class="btngrouping">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <%if (showEventCodes) {  %>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{EVENT_NAME}}">Event Name</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{EVENT_DATE}}">Event Date</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{EVENT_LINK}}">Event Link</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{EVENT_CATEGORY}}">Event Category Name</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{MANAGER_LINK}}">Link to the manager login page</a></li>
                                <%} %>
                                <%if (showWorkflowCodes) {  %>
                                 <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{WORKFLOW_STEP_LINK}}">Link to the signature page for the step the manager is invited to</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{WORKFLOW_NAME}}">Workflow Name</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{WORKFLOW_STEP_BUTTON_TEXT}}">Workflow step button text (name)</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{WORKFLOW_PATH}}">List of steps for the workflow path the user was invited to</a></li>
                                  <li><a href="javascript:void(0);" class="btnAddMsg" data-msg="{{MANAGER_LINK}}">Link to the manager login page</a></li>
                                <%} %>
