<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="WaiverFile.site.Error" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="/site/css/robot_styles.css"/>
    <script src="/site/includes/TweenMax.min.js" type="text/javascript"> </script>
    <script type="text/javascript" src="/site/includes/brokebot.js"></script>
    <script src="/site/includes/snap.svg-min.js" type="text/javascript"></script>
...
<body>
	...
	<div>
		...
		<div class="robotpage-bottom-half">
			...
			<div>
				<p id="robot-text">Oops!</p>
				<p>Looks like something went wrong. <br />
                   We've logged the error and notified our development team.</p>
                    <p>Sorry about that! </p>
				<div class="robot-buttons">
					<a class="robot-buttons" href="default.aspx">Continue</a> 
				</div>
			</div>
