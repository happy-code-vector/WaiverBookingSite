<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListWFPlans2.ascx.cs" Inherits="WaiverFile.WFSubscriptions.Controls.ListWFPlans2" %>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><%=Service.ToString() %> Plans - Main
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><%=Service.ToString() %> Plans - Private
...
where status=@status and service=@service
 order by name">
                  </asp:SqlDataSource>
