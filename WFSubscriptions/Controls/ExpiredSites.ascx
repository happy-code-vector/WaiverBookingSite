<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpiredSites.ascx.cs" Inherits="WaiverFile.WFSubscriptions.Controls.ExpiredSites" %>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Expired Sites
</h3>
    </div><!-- /.box-header -->
    <div class="box-body no-padding">

       <rad:RadGrid Skin="Waypoint" EnableEmbeddedSkins="False"  id="RadGrid1" runat="server" DataSourceID="sqlDataSource1" AutoGenerateColumns="False" OnDeleteCommand="RadGrid1_DeleteCommand">
        <mastertableview datasourceid="sqlDataSource1" DataKeyNames="WFSubscriptionID"><Columns>
...
<rad:GridBoundColumn DataField="name" UniqueName="name" HeaderText="Site Name" FilterControlAltText="Filter name column" SortExpression="name"></rad:GridBoundColumn>
            ...
            <rad:GridBoundColumn DataField="cc" UniqueName="cc" HeaderText="Card" FilterControlAltText="Filter cc column" SortExpression="cc"></rad:GridBoundColumn>
             ...
             <rad:GridBoundColumn DataField="last_login" DataType="System.DateTime" FilterControlAltText="Filter last_login column" HeaderText="Last Login" SortExpression="last_login" UniqueName="last_login" DataFormatString="{0:d}">
            </rad:GridBoundColumn>

            <rad:GridBoundColumn DataField="numused" UniqueName="numused" HeaderText="Recent Waivers" FilterControlAltText="Filter numused column" SortExpression="numused"></rad:GridBoundColumn>
