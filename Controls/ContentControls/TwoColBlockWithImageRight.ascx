<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TwoColBlockWithImageRight.ascx.cs" Inherits="WaiverFile.Controls.ContentControls.TwoColBlockWithImageRight" %>
