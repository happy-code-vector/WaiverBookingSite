<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignupCustom4.ascx.cs" Inherits="WaiverFile.Controls.SignupCustom4" %>
...
<div class="form-group">
<asp:Button ID="btnSubmit" runat="server" Text="Setup Online Waiver" CssClass="btn btn-primary trial-submit-btn" OnClientClick="return preventMultipleSubmissions('.trial-submit-btn');" OnClick="btnSubmit_Click" />
