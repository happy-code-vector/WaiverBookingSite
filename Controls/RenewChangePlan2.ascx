<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RenewChangePlan2.ascx.cs" Inherits="WaiverFile.Controls.RenewChangePlan2" %>
...
<legend>Billing Information</legend>
      ...
      <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <%} %>
                <div class="form-group"><label>State/Province <span class="text-danger">*</span></label><asp:DropDownList ID="cboState" runat="server" CssClass="form-control"/></div>
