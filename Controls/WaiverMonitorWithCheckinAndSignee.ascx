<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WaiverMonitorWithCheckinAndSignee.ascx.cs" Inherits="WaiverFile.Controls.WaiverMonitorWithCheckinAndSignee" %>
                    ...
                    success: function (dataRaw) {
                        if (dataRaw == 'ACCESS_DENIED') {
                            ...
                            for (i = 0; i < data["GenAdm"].length; i++) {
                                ...
                                newBody += '</td><td>';
                                if (!hideExtra) { newBody += data['GenAdm'][i]['SigneeLast'] + ', ' + data['GenAdm'][i]['SigneeFirst']; }
                            ...
                            for (j = 0; j < data["Events"].length; j++) {
                                ...
                                for (i = 0; i < data["Events"][j]["WaiverLines"].length; i++) {
                                    ...
                                    if (!hideExtra) { newBody += '</a>'; }
                                    newBody += '</td><td>';
                                    if (!hideExtra) { newBody += data["Events"][j]["WaiverLines"][i]['SigneeLast'] + ', ' + data["Events"][j]["WaiverLines"][i]['SigneeFirst']; }
                            ...
                            for (i = 0; i < data["Advance"].length; i++) {
                                ...
                                if (!hideExtra) { newBody += '</a>'; }
                                newBody += '</td><td>';
                                if (!hideExtra) { newBody += data['Advance'][i]['SigneeLast'] + ', ' + data['Advance'][i]['SigneeFirst']; }
