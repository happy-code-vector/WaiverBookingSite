<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SandboxSignup.ascx.cs" Inherits="WaiverFile.Controls.SandboxSignup" %>
...
<script type="text/javascript">
    function updateUrlPreview() {
        ...
        if (val == "") {
            val = "sandbox.waiverfile.com/b/yoursite";
        } else {
            val = 'sandbox.waiverfile.com/b/' + val;
...
<div class="form-group">
    ...
    <div class="form-group">
        <asp:CheckBox ID="chkAgreeTerms" runat="server" /> I have read and agree to the <a href="/Policies/Terms-of-Use.aspx" target="_blank">Terms of Use <i class="fa fa-external-link"></i></a>.
    </div>
<div class="form-group">
        <label>Site Path (optional)</label><br />
    sandbox.waiverfile.com/b/
        <asp:TextBox id="txtUrlPrefix" runat="server" CssClass="form-control" placeholder="yoursite" style="width:auto; display:inline-block;"></asp:TextBox> <span id="avail"></span><br />
