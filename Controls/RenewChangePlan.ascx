<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RenewChangePlan.ascx.cs" Inherits="WaiverFile.Controls.RenewChangePlan" %>
...
<legend>Billing Information</legend>
      ...
      <div class="row">
            <div class="col-xs-12 col-sm-6">
                  <div class="form-group"><label>First Name</label><asp:TextBox ID="txtFirst" runat="server" CssClass="form-control"/></div>
                  <div class="form-group"><label>Last Name</label><asp:TextBox ID="txtLast" runat="server" CssClass="form-control"/></div>
                <div class="form-group"><label>Company</label><asp:TextBox ID="txtCompany" runat="server" CssClass="form-control"/></div>
                <div class="form-group"><label>Address</label><asp:TextBox ID="txtAddress" runat="server" CssClass="form-control"/></div>
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="form-group"><label>Country</label><asp:DropDownList ID="cboCountry" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="cboCountry_SelectedIndexChanged"/></div>
                <%} %>
                <div class="form-group"><label>State/Province</label><asp:DropDownList ID="cboState" runat="server" CssClass="form-control"/></div>
