<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFViewer2.ascx.cs" Inherits="WaiverFile.Controls.WorkflowUI.WFViewer2" %>
...
<div class="row" runat="server" id="divStepsWrap">
    <div class="col-xs-12">

        <div class="pull-right">
            <asp:CheckBox runat="server" ID="chkFilterSteps" Text="Filter" AutoPostBack="true" OnCheckedChanged="chkFilterSteps_CheckedChanged" />
        <asp:LinkButton runat="server" ID="btnExportExcelSteps" CssClass="btn btn-sm btn-default" OnClick="btnExportExcelSteps_Click">
        ...
        <!-- leaving off here!  asking ryan to help me make a query for this  -->
        
<telerik:RadGrid Skin="Bootstrap"  ID="rgSteps" runat="server"    AutoGenerateColumns="False"  DataSourceID="SqlDataSource2"  >
    <MasterTableView ClientDataKeyNames="ID" datasourceid="SqlDataSource2"  >
    ...
    <Columns>
         ...
         <telerik:GridHyperLinkColumn DataTextField="buttonText" AllowSorting="False"  DataNavigateUrlFields="ID" HeaderText="Step"  UniqueName="buttonText">
            </telerik:GridHyperLinkColumn>

        <telerik:GridBoundColumn DataField="Participants" FilterControlAltText="Filter Participants column" HeaderText="Participants" SortExpression="Participants" UniqueName="Participants"></telerik:GridBoundColumn>
    ...
    <GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:WaiverFileDB %>"  ProviderName="System.Data.SqlClient" SelectCommand="spWFWorkflowNavViewer" SelectCommandType="StoredProcedure">
    <SelectParameters>
...
<div class="row" runat="server" id="divParts">
    <div class="col-xs-12">

        <div class="pull-right">
            <asp:CheckBox runat="server" ID="chkFilter2" Text="Filter" AutoPostBack="true" OnCheckedChanged="chkFilterSteps_CheckedChanged" />
        <asp:LinkButton runat="server" ID="btnExport" CssClass="btn btn-default btn-sm" OnClick="BtnExport_Click"><i class="fa fa-download" ></i> Export to Excel</asp:LinkButton>
             </div>
...
<hr />
<div class="row" runat="server" id="divPartsRemoved">
    <div class="col-xs-12">
...
where w.waiverisDeleted=0 and wpw.WorkflowStepID=@WorkflowStepID and IsCurrent=1 and IsIncluded=0">
    <SelectParameters>
        <asp:Parameter Name="WorkflowStepID" DefaultValue="00000000-0000-0000-0000-000000000000" />
    </SelectParameters>
</asp:SqlDataSource>
