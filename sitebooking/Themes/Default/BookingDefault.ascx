<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BookingDefault.ascx.cs" Inherits="WaiverFile.sitebooking.Themes.Default.BookingDefault" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover">
 ...
 <div class="offcanvas offcanvas-top" id="searchBox" data-bs-backdrop="static" tabindex="-1">
  ...
  <uc1:Footer runat="server" id="Fotoer1" />
    ...
    <script src="/sitebooking/Themes/Default/js/theme.min.js"></script>
