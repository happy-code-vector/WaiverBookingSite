...
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover">
 ...
 <link rel="preload" href="/sitebooking/Themes/Sample/fonts/inter-variable-latin.woff2" as="font" type="font/woff2" crossorigin>

     <!-- Font icons -->
 <link rel="preload" href="/sitebooking/Themes/Sample/icons/cartzilla-icons.woff2" as="font" type="font/woff2" crossorigin>
 <link rel="stylesheet" href="/sitebooking/Themes/Sample/icons/cartzilla-icons.min.css">


     <!-- Bootstrap + Theme styles -->
 <link rel="preload" href="/sitebooking/Themes/Sample/css/theme.min.css" as="style">
 <link rel="preload" href="/sitebooking/Themes/Sample/css/theme.rtl.min.css" as="style">
 <link rel="stylesheet" href="/sitebooking/Themes/Sample/css/theme.min.css" id="themestyles">
 ...
 <div class="offcanvas offcanvas-top" id="searchBox" data-bs-backdrop="static" tabindex="-1">
  ...
  <uc1:Footer runat="server" id="Fotoer1" />
    ...
    <script src="/sitebooking/Themes/Sample/js/theme.min.js"></script>
