<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormMailChimp.ascx.cs" Inherits="WaiverFile.Connectors.Controls.FormMailChimp" %>
...
<asp:PlaceHolder ID="phErr" runat="server"></asp:PlaceHolder>
        ...
        <div class="form-group">
            ...
            <asp:DropDownList runat="server" CssClass="form-control" ID="cboList" AutoPostBack="true" OnSelectedIndexChanged="cboList_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="form-group">
            <label>When to Send Records to MailChimp</label>
        ...
        <asp:Panel runat="server" ID="pnlAddOptInToForms">
         ...
         <div class="form-group">
            ...
            <p class="help-block">Match the fields in WaiverFile with the filds in MailChimp</p>
        </div>
...
<asp:PlaceHolder ID="phPastDataErr" runat="server"></asp:PlaceHolder>
        ...
        <p>The MailChimp connector will push new data to your MailChimp account once per hour, as it is collected. Use the button below to push all your past data over to MailChimp now.</p>
    ...
    <div class="box-footer">
        <asp:Button runat="server" ID="btnSyncPastData" CssClass="btn btn-primary" Text="Send All Data to MailChimp" OnClick="btnSyncPastData_Click"  />
    </div>
</div>
