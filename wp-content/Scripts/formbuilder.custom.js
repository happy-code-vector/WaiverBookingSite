/*customzied to better support asp.net*/
(function () {
...
/* DISABLING SOME FORM TYPES FOR NOW. WE CAN ADD THEM IN LATER. */
/*
(function() {
...
changing this to the line below. 
*/
...
this["Formbuilder"]["templates"]["view/base_non_input"] = function (obj) {
    ...
    with (obj) {
        __p += '<div class=\'subtemplate-wrapper\'>\n  <div class=\'cover\'></div>\n  ' +
        ((__t = (Formbuilder.templates['view/label/notrequired']({ rf: rf }))) == null ? '' : __t) +
        '\n\n  ' +
        ((__t = (Formbuilder.fields[rf.get(Formbuilder.options.mappings.FIELD_TYPE)].view({ rf: rf }))) == null ? '' : __t) +
        '\n\n  ' +
        ((__t = (Formbuilder.templates['view/description']({ rf: rf }))) == null ? '' : __t) +
...
this["Formbuilder"]["templates"]["view/label/notrequired"] = function (obj) {
    obj || (obj = {});
    var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
    function print() { __p += __j.call(arguments, '') }
    with (obj) {
