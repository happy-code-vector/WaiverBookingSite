                        ...
                        <tr>
                          <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                            ...
                            <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                              ...
                              <br/>
                              <a href="mailto:{/Main/Customer/Email}">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="font-family:sans-serif;font-size:14px;vertical-align:top;background-color:#ffffff;border-radius:5px;text-align:center;background-color:#005dac;">
                                            <a href="https://www.waiverfile.com/wp-admin/default.aspx?sc=WF_VIEW_LEAD&amp;id={/Main/Lead/ID}" target="_blank" style="border: solid 1px #005dac;border-radius: 5px;box-sizing: border-box;cursor: pointer;display: inline-block;font-size: 14px;font-weight: bold;margin: 0;padding: 12px 25px;text-decoration: none;text-transform: capitalize;background-color: #005dac;color: #ffffff;">
                                              View / Manage Lead
                                            </a>
                                          </td>
                                        </tr>
                            ...
                            <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Thanks! ~The WaiverFile Team</p>
