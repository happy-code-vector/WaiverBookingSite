      ...
      <table class="table table-condensed" id="GENADM">
        <thead>
          ...
          <tr>
            <th width="1%"></th>
            <th>
              <asp:LinkButton id="btnSort_GenAdm_Name"  data-sortsect="GENADM" CssClass="sort" data-sortasc="0" data-sortdesc="1" runat="server" Text="Participant"/>
            </th>

            <th>
              <asp:LinkButton id="btnSort_GenAdm_Signee"  data-sortsect="GENADM" CssClass="sort" data-sortasc="8" data-sortdesc="9" runat="server" Text="Signee"/>
            </th>
        ...
        <thead>
          <tr>
            <th colspan="5">
              ...
              <h5>
                <a href="/admin/EventSignatures.aspx?id={WaiverEventID}"><xsl:value-of select="Name"/></a>
                <xsl:text> - </xsl:text>
          ...
          <tr>
            <th width="1%"></th>
            <th>
              <asp:LinkButton id="btnSort_Evt_{translate(WaiverEventID,'-','_')}_Name" data-sortsect="EVT" data-eventid="{WaiverEventID}" CssClass="sort" data-sortasc="0" data-sortdesc="1" runat="server" Text="Participant"/>
            </th>
            <th>
              <asp:LinkButton id="btnSort_Evt_{translate(WaiverEventID,'-','_')}_Signee"  data-sortsect="EVT" data-eventid="{WaiverEventID}" CssClass="sort" data-sortasc="8" data-sortdesc="9" runat="server" Text="Signee"/>
            </th>
            <th class="text-center">
      ...
      <table class="table table-condensed" id="ADVANCE">
        ...
        <tr>
          ...
          <tr>
            <th width="1%"></th>
            <th>
              <asp:LinkButton id="btnSort_Advance_Name"  data-sortsect="ADVANCE" CssClass="sort" data-sortasc="0" data-sortdesc="1" runat="server" Text="Participant"/>
            </th>
            <th>
              <asp:LinkButton id="btnSort_Advance_Signee"  data-sortsect="ADVANCE" CssClass="sort" data-sortasc="8" data-sortdesc="9" runat="server" Text="Signee"/>
            </th>
            <th class="text-center">
