...
xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <xsl:variable name="EventIDAddition">
    <xsl:if test="$EventID!=''">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                        <tr>
                          <td colspan="3" style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            ...
                            <xsl:choose>
                              <xsl:when test="count(/WorkflowStep)!=0">
                                <!-- just one item invited here -->
                                <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                ...
                                <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="/WorkflowStep/BreadcrumbString!=''">
                                      <xsl:value-of select="/WorkflowStep/BreadcrumbString" disable-output-escaping="yes"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                                      <xsl:value-of select="/WorkflowStep/ButtonText"/>
                                    </xsl:otherwise>
                                  </xsl:choose>
                              ...
                              <xsl:otherwise>
                                <!-- multiple invites -->
                                <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                  You have been granted access to view waiver entries for the items listed below.
                                </p>
                              </xsl:otherwise>
                            </xsl:choose>
                        ...
                        <tr>
                                  ...
                                  <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                    ...
                                    <p style="font-family: sans-serif; font-size: 12px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                      ...
                                      <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                          If you do not remember your password, use the forgot password link on the sign-in page.
                                        </xsl:otherwise>
                                      </xsl:choose>
                          ...
                          <td width="280" style="font-family: sans-serif; font-size: 14px; vertical-align: top;width:280px;">
                            ...
                            <!-- show this only when invited to just one item -->
                            <xsl:if test="count(/WorkflowStep)!=0">
                                    ...
                                    <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                        <tbody>
                                          <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #0083ca; border-radius: 5px; text-align: center;">
                                              <a href="{$BaseUrl}/Workflow.aspx?stepid={/WorkflowStep/ID}{$EventIDAddition}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #0083ca; border: solid 1px #0083ca; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #0083ca;">
                                                Waiver Link
                                              </a>
                                            </td>
                                          </tr>
                                      ...
                                      <br/>
                                      <p style="font-family: sans-serif; font-size: 12px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                        Share the link to this waiver:
                                      </p>
                                      <p style="font-family: sans-serif; font-size: 12px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                        <a href="{$BaseUrl}/Workflow.aspx?stepid={/WorkflowStep/ID}{$EventIDAddition}">
                                          <xsl:value-of select="$BaseUrl" />
                                          <xsl:text>/Workflow.aspx?stepid=</xsl:text>
                                          <xsl:value-of select="/WorkflowStep/ID" />
                                          <xsl:value-of select="$EventIDAddition"/>
                                        </a>
                                      </p>
                                    </td>
                                  </tr>
                        ...
                        <!-- show this only when invited to multiple -->
                        <xsl:if test="count(/WorkflowStep)=0">
                          <tr>
                            <td colspan="3">
                              <p style="font-family: sans-serif; font-size: 12px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                <strong>You have been invited to the following:</strong>
                              </p>
                              <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">
                                <tbody>
                                  <xsl:for-each select="/WorkflowStepManagerInvitePack/Steps/WorkflowStep">
                                    <tr>
                                      <td>
                                        <xsl:value-of select="BreadcrumbString" disable-output-escaping="yes"/>
                                      </td>
                                      <td>
                                        <a href="{$BaseUrl}/Workflow.aspx?stepid={ID}{$EventIDAddition}" target="_blank" >
                                          Waiver Link
                                        </a>
                                      </td>
                                    </tr>
