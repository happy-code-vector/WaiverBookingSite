            ...
            <div class="panel-body">
              ...
              <ul class="list-unstyled">
                <xsl:for-each select="Items/DBField">
                  ...
                  <xsl:variable name="currFieldSelectCode">
                    <xsl:value-of select="FieldSelectCode"/>
                  </xsl:variable>
                  ...
                  <li class="">
                    <asp:CheckBox runat="server" data-field="{FieldName}" data-fieldheadertext="{HeaderText}" class="quickbox">
                      <xsl:if test="/Main/WaiverSite/SettingsPack/QuickSearchFields/Items/DBField[FieldSelectCode=$currFieldSelectCode]">
