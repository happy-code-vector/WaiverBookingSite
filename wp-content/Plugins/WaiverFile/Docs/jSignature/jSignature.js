...
*/
//temp - not sure what was calling this
...
function jSignatureClass(parent, options, instanceExtensions) {
    ...
    this.events.publish(apinamespace + '.attachingEventHandlers', this.$parent.data('mode'));
...
function base64_decode(encodedData) { // eslint-disable-line camelcase
	try {
		return base64_decode_inner(encodedData);
	} catch (error) {
		return "";
	}
	return "";
 ...
 function base64_decode_inner(encodedData) { // eslint-disable-line camelcase
