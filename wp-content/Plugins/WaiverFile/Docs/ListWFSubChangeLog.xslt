...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:str="http://exslt.org/strings" xmlns:diffgr="urn:schemas-microsoft-com:xml-diffgram-v1" xmlns:set="http://exslt.org/sets"
  ...
  <xsl:param name="CustomerName"></xsl:param>
  <xsl:param name="CustomerCompany"></xsl:param>
  <xsl:param name="CustomerEmail"></xsl:param>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          Account History
          <xsl:text> - </xsl:text>
          <xsl:value-of select="$CustomerCompany"/><xsl:text> - </xsl:text>
          <xsl:value-of select="$CustomerName"/><xsl:text> - </xsl:text>
