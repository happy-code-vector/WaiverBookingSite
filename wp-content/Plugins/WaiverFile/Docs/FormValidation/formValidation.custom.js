...
/*adding custom version of choice to support asp.net */
; (function ($) {
    FormValidation.I18n = $.extend(true, FormValidation.I18n || {}, {
        'en_US': {
            choicenet: {
    ...
    FormValidation.Validator.choicenet = {
        html5Attributes: {
            message: 'message',
            min: 'min',
            max: 'max'
        ...
        validate: function (validator, $field, options, validatorName) {
            ...
            var locale = validator.getLocale(),
                ...
                isValid = true,
                message = options.message || FormValidation.I18n[locale].choicenet['default'];

            //CALUCLATE NUMCHOICES
            var cid = $field.data('fieldcid');
            numChoices = $field.parent().parent().find("[data-fieldcidalt='" + cid + "']:checked").length;
            ...
            switch (true) {
                case (!!min && !!max):
                    message = FormValidation.Helper.format(options.message || FormValidation.I18n[locale].choicenet.between, [parseInt(min, 10), parseInt(max, 10)]);
                    break;

                case (!!min):
                    message = FormValidation.Helper.format(options.message || FormValidation.I18n[locale].choicenet.less, parseInt(min, 10));
                    break;

                case (!!max):
                    message = FormValidation.Helper.format(options.message || FormValidation.I18n[locale].choicenet.more, parseInt(max, 10));
                    break;
