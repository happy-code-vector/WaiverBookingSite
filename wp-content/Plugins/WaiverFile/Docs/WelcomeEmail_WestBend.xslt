                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                        <tr>
                          <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                            ...
                            <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Thank you for signing up for WaiverFile! Your new account is set up and ready to use! </p>
                          ...
                          <p class="text-align:center">
                            <a href="https://www.waiverfile.com/Support/Getting-Started-with-Online-Waivers.aspx">
                            ...
                            <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                              Please feel free to contact us with any questions you may have or if you need help getting your account configured. <a href="info@waiverfile.com">info@waiverfile.com</a>
                            </p>
                            <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Thank you for choosing WaiverFile!</p>
                          </td>
                        </tr>
                      </table>
                    </td>
