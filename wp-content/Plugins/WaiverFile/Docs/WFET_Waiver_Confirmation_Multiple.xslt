                                            ...
                                            <tr>
                                              <td>
                                                ...
                                                <p>
                                                  ...
                                                  <xsl:value-of select="dt:format-date(ArrayOfWaiver/Waiver/DateSigned,$DateFormat)"/>
                                                </p>
                                                <table border="0" cellpadding="7" width="450" style=" width:450px;max-width:90%; ">
                                                  <tr>
                                                    <td valign="top" align="left">
                                                      ...
                                                      <br />
                                                      <xsl:value-of select="ArrayOfWaiver/Waiver/SignedNameFirst"/>
                                                      <xsl:text> </xsl:text>
                                                      <xsl:value-of select="ArrayOfWaiver/Waiver/SignedName"/>
                                                      <br />
                                                      <br />
                                                      <xsl:if test="count(ArrayOfWaiver/Waiver/Particpants/WaiverParticipant[IsSignee!='true'])!=0">
                                                        <strong>Participants: </strong>
                                                        <br />

                                                        <xsl:for-each select="ArrayOfWaiver/Waiver/Particpants/WaiverParticipant[IsSignee!='true']">
                                                    ...
                                                    <td valign="top" align="right">
                                                      ...
                                                      <span style="font-size:26px">
                                                        <xsl:value-of select="count(ArrayOfWaiver/Waiver/Particpants/WaiverParticipant)"/>
                                                      </span>
                                                      <br />
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td colspan="4">
                                  ...
                                  <xsl:if test="ArrayOfWaiver/Waiver/WaiverEvent/Name!=''">
                                    <h4>
                                      <xsl:value-of select="ArrayOfWaiver/Waiver/WaiverEvent/Name"/>
                                      <xsl:text> | </xsl:text>
                                      <xsl:value-of select="ArrayOfWaiver/Waiver/WaiverEvent/TimeLabel"/>
                                    </h4>
                                  </xsl:if>
                                </td>
                              </tr>
                              ...
                              <xsl:choose>
                                <xsl:when test="/Main/EmailTemplate/Settings/WaiverCopyIncludeMode='None'">
                                  ...
                                  <xsl:for-each select="ArrayOfWaiver/Waiver">
                                    ...
                                    <tr>
                                      <td colspan="4">
                                        <h3 style="font-size:16px;padding-top:20px;">
                                ...
                                <xsl:when test="/Main/EmailTemplate/Settings/WaiverCopyIncludeMode='Complete' or /Main/EmailTemplate/Settings/WaiverCopyIncludeMode='Partial'">
                                  ...
                                  <xsl:for-each select="/Main/ArrayOfWaiver/Waiver">
                                    <xsl:variable name="WaiverNum">
                                      <xsl:value-of select="position()"/>
                                    </xsl:variable>
                                    <tr>
                                    ...
                                    <tr>
                                      <xsl:choose>
                                        <xsl:when test="count(Particpants/WaiverParticipant[ParticipantNameFirst!=''])!=0">
                                          ...
                                          <xsl:if test="$OmitCustomFields!='true' and /Main/EmailTemplate/Settings/WaiverCopyIncludeMode='Complete' and  count(Particpants/WaiverParticipant[DOB!='' and DOB!='1/1/1753'])!=0">
                                            <td colspan="2">
                                        ...
                                        <xsl:choose>
                                          <xsl:when test="count(../../Particpants/WaiverParticipant[ParticipantNameFirst!=''])!=0">
                                            ...
                                            <xsl:if test="count(../../Particpants/WaiverParticipant[DOB!='' and DOB!='1/1/1753'])!=0">
                                              <xsl:if test="$OmitCustomFields!='true' and /Main/EmailTemplate/Settings/WaiverCopyIncludeMode='Complete' and DOB!='' and DOB!='1/1/1753'">
                                                <td colspan="2" valign="top" style="font-weight:bold; color:#162440; ">
                                    ...
                                    <tr>
                                      <td colspan="4">
                                        ...
                                        <xsl:choose>
                                          ...
                                          <xsl:otherwise>
                                            <xsl:if test="HasSignature='true' and /Main/SignatureCIDs/string[position()=$WaiverNum]!=''">
                                              <img src="cid:{/Main/SignatureCIDs/string[position()=$WaiverNum]}" alt="Signature" style="max-width:100%"></img>
                                            </xsl:if>
                                          </xsl:otherwise>
                                        </xsl:choose>
