    ...
    <xsl:template match="/Waiver">
      <html>
        <head>
          ...
          <link rel="stylesheet" type="text/css" href="../includes/export.css"/>
        ...
        <body>
          ...
          <table width="{$TableWidth}" border="0" class="structuretable">
              ...
              <xsl:if test="HasSignature='true'">
                <tr>
                  <td colspan="2"  class="signaturecell">
                    <img src="signatures/{WaiverID}.svg" class="img-responsive" alt="Signature"></img>
                  </td>
                </tr>
              </xsl:if>
          ...
          <div style="text-align:center">
            <a href="http://www.waiverfile.com">
              <img src="../includes/powered-by-waiverfile.gif" alt="Powered By WaiverFile"/>
            </a>
          </div>
