    ...
    <html>
      ...
      <body class="" style="background-color:#ffffff;color:#575e68;font-family:sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;line-height:1.4;margin:0;padding:0;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
        ...
        <p style="color:#575e68;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
          ...
          We just wanted to reach out to thank you for trying WaiverFile! We hope your experience so far has been great. It looks like you got your form set up and configured. Did you have any questions about the settings in there? Let us know if there is anything we can assist with.

        </p>
        <a href="https://www.waiverfile.com/b/{Sites/WaiverSite/Url}/admin" target="_blank">Manage Your Account Here</a>
