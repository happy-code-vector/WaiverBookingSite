    ...
    <html>
      ...
      <body class="" style="background-color:#ffffff;color:#575e68;font-family:sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;line-height:1.4;margin:0;padding:0;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
        ...
        <p style="color:#575e68;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
          ...
          We have attempted to reach you several times but have not heard back and your WaiverFile account is still past due. Your service is scheduled to be suspended in 3 days if payment is not received on or before that date. Once your account is suspended, service will not be reactivated until the full past due amount is submitted. Please contact us as soon as possible to resolve this matter.
