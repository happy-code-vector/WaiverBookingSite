    ...
    <html>
      ...
      <body class="" style="background-color:#ffffff;color:#575e68;font-family:sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;line-height:1.4;margin:0;padding:0;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
        ...
        <p style="color:#575e68;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
          ...
          Your WaiverFile account still has no plan selected and has been marked to be closed. If you wish to use the service, you can still select a plan. Please <a href="https://www.waiverfile.com/b/{Sites/WaiverSite/Url}/admin/Settings/Renew.aspx">log in here</a> to select a plan and continue using WaiverFile! If you have any questions that we can assist with, please feel free to contact us and we will be happy to help!
